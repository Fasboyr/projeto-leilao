...
public class AuctionWebSocketController {
    ...
    public BidMessageReponse handleBid(BidMessageRequest bidMessage) {
        ...
        auctionBid.setEmailUserBid(jwtService.extractUsername(bidMessage.getUserToken()));
        auctionBid.setValueBid(auctionBid.getValueBid() + auction.getIncrementValue());
        bidRepository.save(auctionBid);
        return new BidMessageReponse(auction.getId(), auctionBid.getPerson().getEmail(), auctionBid.getValueBid());
    }
}
